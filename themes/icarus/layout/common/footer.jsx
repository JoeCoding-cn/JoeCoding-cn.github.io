            ...
            <div class="container">
                ...
                <div class="level">
                    <div class="level-start">
                        ...
                        <meting-js
                            auto="https://y.qq.com/n/yqq/playlist/7638964984.html#stat=y_new.profile.create_playlist.click&dirid=28"
                            fixed="true"
                            type="playlist"
                            autoplay="true"
                            loop="all"
...
module.exports = cacheComponent(Footer, 'common.footer', props => {
    ...
    return {
        logo,
        llogoLightUrl: url_for(logoLight),
